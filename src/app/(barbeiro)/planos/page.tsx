  ...
  return (
    <div className="p-6">
      ...
      <div className="space-y-3">
        {planos.map((p) => (
          <div key={p.id} className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-4 shadow-sm">
        ...
        {planos.length === 0 && <p className="text-neutral-400 dark:text-neutral-500">Nenhum plano ativo no momento.</p>}
      </div>
    </div>
  );
}
