...
export function DespesaRow({
  ...
  return (
    <div className="flex items-center justify-between gap-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm">
      <div>
        <p className="font-semibold">{descricao}</p>
        <p className="text-slate-500 dark:text-slate-400 text-sm">{data.toLocaleDateString("pt-BR")}</p>
      </div>
