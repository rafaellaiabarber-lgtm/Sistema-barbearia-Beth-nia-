...
export function MobileNav({ grupos, nome }: { grupos: NavGrupo[]; nome: string }) {
  ...
  return (
    <div className="md:hidden border-b border-blue-500/10 bg-black relative">
      ...
      {aberto && (
        <nav className="absolute left-0 top-full z-10 w-64 max-h-[80vh] overflow-y-auto bg-black border border-blue-500/10 rounded-br-xl shadow-xl flex flex-col gap-3 p-3">
          {grupos.map((g) => (
