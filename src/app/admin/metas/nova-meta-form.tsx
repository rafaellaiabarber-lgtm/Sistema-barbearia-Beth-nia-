...
export function NovaMetaForm({
  ...
  return (
    <details className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-4 mb-6 shadow-sm">
      <summary className="cursor-pointer font-semibold text-neutral-800 dark:text-neutral-100 select-none">Nova meta</summary>
      <form ref={formRef} action={formAction} className="mt-4">
        <div className="flex flex-wrap items-end gap-3 mb-4">
          ...
          <div>
            <label className="block text-xs text-neutral-500 dark:text-neutral-400 mb-1">Tipo de meta</label>
            <select
              ref={tipoSelectRef}
              name="tipo"
              value={tipo}
          ...
          {ehVendaProduto ? (
            <div>
              <label className="block text-xs text-neutral-500 dark:text-neutral-400 mb-1">Produto (opcional)</label>
              <select
            ...
            <div>
              <label className="block text-xs text-neutral-500 dark:text-neutral-400 mb-1">Serviço (opcional)</label>
              <select
        ...
        <div className="flex flex-wrap items-end gap-3 mb-4">
          <div>
            <label className="block text-xs text-neutral-500 dark:text-neutral-400 mb-1">Data início (opcional)</label>
            <input
              name="dataInicio"
              type="date"
              className="rounded-lg bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-sm"
          ...
          <div>
            <label className="block text-xs text-neutral-500 dark:text-neutral-400 mb-1">Data fim (opcional)</label>
            <input
              name="dataFim"
              type="date"
              className="rounded-lg bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-sm"
          ...
          <p className="text-neutral-400 dark:text-neutral-500 text-xs pb-2">Deixe em branco pra usar sempre o mês atual.</p>
        </div>
        ...
        <button
          type="submit"
          disabled={pendente}
          className="mt-4 rounded-lg bg-orange-600 hover:bg-orange-700 disabled:opacity-60 text-white font-semibold px-4 py-2 text-sm"
        >
