    ...
    <details className="bg-white border border-slate-200 rounded-xl p-4 mb-6 shadow-sm">
      ...
      <form ref={formRef} action={formAction} className="mt-4">
        <div className="flex flex-wrap items-end gap-3 mb-4">
          ...
          {ehVendaProduto ? (
            <div>
              <label className="block text-xs text-slate-500 mb-1">Produto (opcional)</label>
              <select
            ...
            <div>
              <label className="block text-xs text-slate-500 mb-1">Serviço (opcional)</label>
              <select
        ...
        <div className="flex flex-wrap items-end gap-3 mb-4">
          <div>
            <label className="block text-xs text-slate-500 mb-1">Data início (opcional)</label>
            <input
              name="dataInicio"
              type="date"
              className="rounded-lg bg-white border border-slate-300 px-3 py-2 text-sm"
          ...
          <div>
            <label className="block text-xs text-slate-500 mb-1">Data fim (opcional)</label>
            <input
              name="dataFim"
              type="date"
              className="rounded-lg bg-white border border-slate-300 px-3 py-2 text-sm"
          ...
          <p className="text-slate-400 text-xs pb-2">Deixe em branco pra usar sempre o mês atual.</p>
        </div>
