        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-3">
            <div className="flex flex-col items-start gap-1">
              <span className="text-xs text-neutral-400 dark:text-neutral-500">Custo</span>
              <CustoServicoForm servicoId={servico.id} custoCentavos={servico.custoCentavos} />
            </div>
            <div className="flex flex-col items-start gap-1">
              <span className="text-xs text-neutral-400 dark:text-neutral-500">Comissão</span>
              <ComissaoServicoForm servicoId={servico.id} comissaoPercentual={servico.comissaoPercentual} />
            </div>
            <div className="flex flex-col items-start gap-1">
              <span className="text-xs text-neutral-400 dark:text-neutral-500" title="Usado na Distribuição de Assinatura pra dividir o pote proporcionalmente">
                Fichas
              </span>
