          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <form action={alternarPontuaRanking.bind(null, servico.id, !servico.pontuaRanking)}>
                <button
                  className={`text-sm ${servico.pontuaRanking ? "text-lime-600 dark:text-lime-400 hover:text-lime-800" : "text-slate-400 dark:text-slate-500 hover:text-lime-600 dark:hover:text-lime-400"}`}
