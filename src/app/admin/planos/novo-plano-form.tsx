...
export function NovoPlanoForm() {
  ...
  return (
    ...
    >
      ...
      <div>
        <label className="block text-xs text-neutral-500 dark:text-neutral-400 mb-1">Serviços incluídos/mês</label>
        <input
          name="cota"
          type="number"
          min={1}
      ...
      <div className="w-full">
        ...
        <div className="flex flex-wrap gap-2">
          {NOMES_DIAS_SEMANA.map((nome, i) => (
            ...
            >
              <input type="checkbox" name="diasSemana" value={i} className="accent-orange-600" />
              {nome}
            </label>
          ))}
        </div>
