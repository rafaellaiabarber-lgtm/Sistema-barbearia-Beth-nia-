    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm">
          ...
          <p className="text-2xl font-bold text-lime-600 dark:text-lime-400">{ativas.length}</p>
        </div>
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                {a.status === "CANCELADA" && (
                  <form action={reativarAssinatura.bind(null, a.id)}>
                    <button className="text-sm text-lime-600 dark:text-lime-400 hover:underline">Reativar</button>
                  </form>
                )}
              </div>
            </div>
