...
export function NovoMaterialForm() {
  ...
  return (
    <form
      ref={formRef}
      action={formAction}
      className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-4 mb-6 space-y-3 shadow-sm"
    >
      ...
      {tipo === "TEXTO" && (
        <div>
          <label className="block text-xs text-neutral-500 dark:text-neutral-400 mb-1">Texto</label>
          <textarea
            name="conteudo"
            required
            rows={4}
